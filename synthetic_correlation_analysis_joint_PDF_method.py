...
for demands generated using a joint PDF sampling method.
...
synthetic_unit_demand = np.loadtxt('./data/synthetic/synthetic_unit_demand_JPM.csv', delimiter = ',')
...
p2.set_axis_labels('Synthetic Log-Inflow', 'Synthetic Unit Demand', fontsize=14)
...
p2.savefig('./figures/Synthetic_Annual_joint_pdf_JPM.png')
...
p4.set_axis_labels('Synthetic Log-Inflow', 'Synthetic Unit Demand', fontsize=14)
...
p4.savefig('./figures/Synthetic_Irrigation_joint_pdf_JPM.png')
...
# Plot synthetic maps
plot_correlation_map(annual_synthetic_corr_structure, './figures/Synthetic_annual_correlation_JPM', historic_data = False, annual_data = True)
plot_correlation_map(annual_synthetic_corr_structure, './figures/Synthetic_irrigation_correlation_JPM', historic_data = False, annual_data = False)
...
p6.savefig('./figures/Synthetic_joint_pdf_JPM.png')

###############################################################################
            ### Visualize non-standard joint distribution ###
###############################################################################

plot_all_years(historic_unit_demand, synthetic_unit_demand, 'Unit Demand', 'Demand_unit_compariso_JPM', my_color = 'blue', highlight_mean = True, standardized = False)
plot_all_years(historic_standard_demand, synthetic_standard_demand, 'Weekly Standardized Demand', 'Demand_standard_compariso_JPM', my_color = 'blue', highlight_mean = True, standardized = False)
